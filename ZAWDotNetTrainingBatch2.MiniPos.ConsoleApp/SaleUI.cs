using ZAWDotNetTrainingBatch2.MiniPos.Domain.Features;
using ZAWDotNetTrainingBatch2.MiniPos.Database.AppDbContexModels;
namespace ZAWDotNetTrainingBatch2.MiniPos.ConsoleApp
{
    public class SaleUI
    {
        public void Execute()
        ...
        public void SaleSummaryListing()
        {
            ...
            foreach (var item in saleSummaryListing)
            {
                ...
                Console.WriteLine("Date  => " + item.DateTime);
